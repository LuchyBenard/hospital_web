...
import { demoRecords, demoVitalTrends } from "@/constants";

let recordsStore = [...demoRecords];
let vitalTrendsStore = [...demoVitalTrends];
...
export function listVitalTrends({ patientId } = {}) {
  if (patientId && patientId !== "patient-001") return [];
  return [...vitalTrendsStore];
}
